        ...
        <View style={styles.sort}>
          ...
          <View
            style={[
              ...
              this.state.data.length % 4 !== 0
                ? {
                    ...
                    zIndex: 999,
                    top:
                      parseInt(this.state.data.length / 4) *
                      (childrenHeight +
            ...
            <TouchableOpacity
              ...
              //     newData.push( {icon: require('../../assets/img/cluster_9.png'),txt: 'New'+this.index})
              //     this.setState({
              //         data: newData
              //     })
              // }}
      ...
      return (
        <View style={styles.item}>
          <View style={styles.item_children}>
            ...
            <Text style={styles.txt}>{item.fileName}</Text>
          </View>
          {/* <Image
